...
export const socialMediaProfiles = [
  { title: 'Instagram', href: 'https://instagram.com/marvhuel', icon: InstagramIcon },
  { title: 'Twitter', href: 'https://twitter.com/marvhuelsmann', icon: TwitterIcon },
  { title: 'GitHub', href: 'https://github.com/marvhuelsmann', icon: GitHubIcon },
]
